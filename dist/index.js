    ...
    inquirer
        ...
        if (action === "add a role") {
            inquirer
                ...
                pool
                    .query("INSERT INTO role(title, salary, department_id) VALUES ($1, $2, $3)", [role_title, role_salary, role_dept])
                    .then(() => {
        ...
        if (action === "add an employee") {
            inquirer
                ...
                pool
                    .query("INSERT INTO employee(first_name, last_name, role_id, manager_id) VALUES ($1, $2, $3, $4)", [emp_first_name, emp_last_name, emp_role, manager_id])
                    .then(() => {
                    console.log(`${emp_first_name} ${emp_last_name} has been added!`);
        ...
        if (action === "update an employee role") {
            inquirer
                ...
                },
                {
                    type: "list",
                    name: "role_id",
                    message: "What is the id of the role that you want to assign to the selected employee?",
                    choices: await getRoleChoices(),
                },
            ])
                .then(({ emp_id, role_id }) => {
